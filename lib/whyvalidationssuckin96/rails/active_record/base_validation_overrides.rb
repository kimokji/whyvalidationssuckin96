...
module WhyValidationsSuckIn96
  module ActiveRecord
    ...
    RemovableClassMethods = %w[validate validates_format_of validates_each
...
module WhyValidationsSuckIn96
  module ActiveModel
    ...
    RemovableInstanceMethods = %w[invalid? errors]
...
ActiveModel::Validations.instance_eval { include WhyValidationsSuckIn96::ActiveModel }